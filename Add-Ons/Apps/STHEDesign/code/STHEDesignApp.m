classdef STHEDesignApp < handle
    ...
    properties (Constant)
        AppPathBase = {'/STHEDesign/code'};
        AppClass = 'STHEDesignApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function startApp(obj)
            ...
            mlock;
            STHEDesignApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'Mini')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong Mini
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'Mini').getString, ...
